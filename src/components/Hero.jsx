...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingX}`}>
    ...
    <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet consectetur
     adipisicing elit. Quos, atque! Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam deleniti magni possimus sapiente? Hic ex dicta error ipsam, voluptas sed nesciunt,
     illo harum omnis libero fugit itaque quaerat necessitatibus dolor.</p>
    </div>
